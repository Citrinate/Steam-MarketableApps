...
if (num_removed > 10000):
    ...
    # The number missing is consistenly high, either around 40,000 or 60,000
    sys.exit(f"::warning::Unusually large number amount of apps removed ({num_removed}), ignoring changes")
